...
describe('analytics', function() {
  ...
  beforeEach(function() {
    ...
    const scope = this;
    analytics.__set__('Analytics', (Analytics = (function() {
    ...
    this.req = { session: {}, body: {}, user: { get() { return 'foo'; } }, query: {} };
    this.res = { locals: { sd: {} } };
  ...
  it('tracks signup', function() {
    ...
    this.analytics.track.args[0][0].properties.signup_service.should.equal('email');
  });
  ...
  it('passes along modal_id and acquisition_initiative submitted fields', function() {
    ...
    analytics.trackSignup('email')(this.req, this.res, this.next);
    this.analytics.track.args[0][0].properties
